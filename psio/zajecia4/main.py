...
# ax = axs[0,1]; ax.plot(sin_f, 10*np.log10(np.abs(sin_pxx))); ax.set_title('Sygnal sinusoidalny o stalej czestotliwosci - periodogram'); ax.set_ylabel("Moc/czestotliwosc [dB/Hz]"); ax.set_xlabel("Czestotliwosc [Hz]")
#
# ax = axs[1,0]; ax.plot(n, sq); ax.set_xlim(0, 0.02); ax.set_title('Sygnal prostokatny'); ax.set_ylabel("Amplituda"); ax.set_xlabel("Czas [s]")
# ax = axs[1,1]; ax.plot(sq_f, 10*np.log10(np.abs(sq_pxx))); ax.set_title('Sygnal prostokatny - periodogram'); ax.set_ylabel("Moc/czestotliwosc [dB/Hz]"); ax.set_xlabel("Czestotliwosc [Hz]")
#
...
# ax = axs[2,1]; ax.plot(traingle_f, 10*np.log10(np.abs(traingle_pxx))); ax.set_title('Sygnal trojkatny - periodogram'); ax.set_ylabel("Moc/czestotliwosc [dB/Hz]"); ax.set_xlabel("Czestotliwosc [Hz]")
#
...
# ax = axs[3,1]; ax.plot(saw_f, 10*np.log10(np.abs(saw_pxx))); ax.set_title('Sygnal piloksztaltny - periodogram'); ax.set_ylabel("Moc/czestotliwosc [dB/Hz]"); ax.set_xlabel("Czestotliwosc [Hz]")
#
# ax = axs[4,0]; ax.plot(n, noise); ax.set_xlim(0, 0.02); ax.set_title('Sygnal szumu'); ax.set_ylabel("Amplituda"); ax.set_xlabel("Czas [s]")
# ax = axs[4,1]; ax.plot(noise_f, 10*np.log10(np.abs(noise_pxx))); ax.set_title('Sygnal szumu - periodogram'); ax.set_ylabel("Moc/czestotliwosc [dB/Hz]"); ax.set_xlabel("Czestotliwosc [Hz]")
#
...
# ax = axs[5,1]; ax.plot(sin_var_f, 10*np.log10(np.abs(sin_var_pxx))); ax.set_title('Sygnal sinusoidalny o zmiennej czestotliwosci - periodogram'); ax.set_ylabel("Moc/czestotliwosc [dB/Hz]"); ax.set_xlabel("Czestotliwosc [Hz]")
#
...
# ax = axs[6,1]; ax.plot(mowa_f, 10*np.log10(np.abs(mowa_pxx))); ax.set_title('Sygnal mowy - periodogram'); ax.set_ylabel("Moc/czestotliwosc [dB/Hz]"); ax.set_xlabel("Czestotliwosc [Hz]")
#
# ax = axs[7,0]; ax.plot(n_muzyki, muzyka); ax.set_title('Sygnal muzyki'); ax.set_ylabel("Amplituda"); ax.set_xlabel("Czas [s]")
# ax = axs[7,1]; ax.plot(muzyka_f, 10*np.log10(np.abs(muzyka_pxx))); ax.set_title('Sygnal muzyki - periodogram'); ax.set_ylabel("Moc/czestotliwosc [dB/Hz]"); ax.set_xlabel("Czestotliwosc [Hz]")
# fig.set_tight_layout(tight=True)
...
# ax = axs[0,0]; mesh = ax.pcolormesh(sin_t, sin_f, 10*np.log10(sin_Sxx)); cb = fig.colorbar(mesh, ax=ax); cb.set_label("Moc/czestotliwosc [dB/Hz]"); ax.set_title('Sygnal sinusoidalny o stalej czestotliwosci'); ax.set_ylabel("Czestotliwosc [Hz]"); ax.set_xlabel("Czas [s]")
# ax = axs[0,1]; mesh = ax.pcolormesh(sq_t, sq_f, 10*np.log10(sq_Sxx)); cb = fig.colorbar(mesh, ax=ax); cb.set_label("Moc/czestotliwosc [dB/Hz]"); ax.set_title('Sygnal prostokatny'); ax.set_ylabel("Czestotliwosc [Hz]"); ax.set_xlabel("Czas [s]")
# ax = axs[1,0]; mesh = ax.pcolormesh(traingle_t, traingle_f, 10*np.log10(traingle_Sxx)); cb = fig.colorbar(mesh, ax=ax); cb.set_label("Moc/czestotliwosc [dB/Hz]"); ax.set_title('Sygnal trojkatny'); ax.set_ylabel("Czestotliwosc [Hz]"); ax.set_xlabel("Czas [s]")
# ax = axs[1,1]; mesh = ax.pcolormesh(saw_t, saw_f, 10*np.log10(saw_Sxx)); cb = fig.colorbar(mesh, ax=ax); cb.set_label("Moc/czestotliwosc [dB/Hz]"); ax.set_title('Sygnal piloksztaltny'); ax.set_ylabel("Czestotliwosc [Hz]"); ax.set_xlabel("Czas [s]")
# ax = axs[2,0]; mesh = ax.pcolormesh(noise_t, noise_f, 10*np.log10(noise_Sxx)); cb = fig.colorbar(mesh, ax=ax); cb.set_label("Moc/czestotliwosc [dB/Hz]");  ax.set_title('Sygnal szumu'); ax.set_ylabel("Czestotliwosc [Hz]"); ax.set_xlabel("Czas [s]")
# ax = axs[2,1]; mesh = ax.pcolormesh(sin_var_t, sin_var_f, 10*np.log10(sin_var_Sxx)); cb = fig.colorbar(mesh, ax=ax); cb.set_label("Moc/czestotliwosc [dB/Hz]"); ax.set_title('Sygnal sinusoidalny o zmiennej czestotliwosci'); ax.set_ylabel("Czestotliwosc [Hz]"); ax.set_xlabel("Czas [s]")
# ax = axs[3,0]; mesh = ax.pcolormesh(mowa_t, mowa_f, 10*np.log10(mowa_Sxx)); cb = fig.colorbar(mesh, ax=ax); cb.set_label("Moc/czestotliwosc [dB/Hz]");  ax.set_title('Sygnal mowy'); ax.set_ylabel("Czestotliwosc [Hz]"); ax.set_xlabel("Czas [s]")
# ax = axs[3,1]; mesh = ax.pcolormesh(muzyka_t, muzyka_f, 10*np.log10(muzyka_Sxx)); cb = fig.colorbar(mesh, ax=ax); cb.set_label("Moc/czestotliwosc [dB/Hz]");  ax.set_title('Sygnal muzyki'); ax.set_ylabel("Czestotliwosc [Hz]"); ax.set_xlabel("Czas [s]")
# fig.set_tight_layout(tight=True)
