...
plt.subplot(3, 2, 1); plt.stem(y); plt.title("Re(y)"); plt.xlabel("Numer probki"); plt.ylabel("Amplituda")
plt.subplot(3, 2, 2); plt.stem(y_im); plt.title("Im(y)"); plt.xlabel("Numer probki"); plt.ylabel("Amplituda")
plt.subplot(3, 2, 3); plt.stem(fft); plt.title("Re(fft(y))"); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Amplituda"); plt.axis((0, 31, -1, 1))
plt.subplot(3, 2, 4); plt.stem(fft_im); plt.title("Im(fft(y))"); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Amplituda")
plt.subplot(3, 2, 5); plt.stem(fft_abs); plt.title("Modul(fft(y))"); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Magnituda")
plt.subplot(3, 2, 6); plt.stem(fft_ang); plt.title("Phase(fft(y))"); plt.ylabel("Faza [pi x rad]"); plt.xlabel("Numer pasma czestotliwosciowego")
plt.tight_layout()
...
plt.subplot(2, 2, 1); plt.stem(y1_fft_ang); plt.title('y1[n] = cos(2πn/N+π/4)'); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Faza [pi x rad]")
plt.subplot(2, 2, 2); plt.stem(y2_fft_ang); plt.title('y2[n] = 0.5cos(4πn/N)'); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Faza [pi x rad]")
plt.subplot(2, 2, 3); plt.stem(y3_fft_ang); plt.title('y3[n] = 0.25cos(8πn/N+π/2)'); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Faza [pi x rad]")
plt.subplot(2, 2, 4); plt.stem(y4_fft_ang); plt.title("y1+y2+y3"); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Faza [pi x rad]")
plt.tight_layout()
...
plt.subplot(3, 2, 1); plt.stem(y); plt.title("Re(y)"); plt.xlabel("Numer probki"); plt.ylabel("Amplituda")
plt.subplot(3, 2, 2); plt.stem(y_im); plt.title("Im(y)"); plt.xlabel("Numer probki"); plt.ylabel("Amplituda")
plt.subplot(3, 2, 3); plt.stem(fft_abs); plt.title("Modul(fft(y))"); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Magnituda")
plt.subplot(3, 2, 4); plt.stem(fft_ang); plt.title("Phase(fft(y))"); plt.ylabel("Faza [pi x rad]"); plt.xlabel("Numer pasma czestotliwosciowego")
plt.subplot(3, 2, 5); plt.stem(ifft); plt.title("Re(ifft(y))"); plt.ylabel("Amplituda"); plt.xlabel("Numer probki")
plt.subplot(3, 2, 6); plt.stem(ifft_img); plt.title("Im(ifft(y))"); plt.ylabel("Amplituda"); plt.xlabel("Numer probki"); plt.axis((-0.2, 15.2, -1.1, 1.1))
plt.tight_layout()
...
plt.subplot(2, 2, 1); plt.stem(y4); plt.title("y1+y2+y3"); plt.xlabel("Numer Probki"); plt.ylabel("Amplituda")
plt.subplot(2, 2, 2); plt.stem(fft_abs); plt.title("Modul Widma"); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Magnituda")
plt.subplot(2, 2, 3); plt.stem(fft_ang); plt.title("Faza Widma"); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Faza [pi x rad]")
plt.subplot(2, 2, 4); plt.stem(ifft); plt.title("ifft(Y)"); plt.xlabel("Numer Probki"); plt.ylabel("Amplituda")
plt.tight_layout()
...
plt.figure(figsize=(12, 14))
plt.subplot(3, 2, 1); plt.stem(y_re); plt.title("Re(y)"); plt.xlabel("Numer probki"); plt.ylabel("Amplituda")
plt.subplot(3, 2, 2); plt.stem(y_im); plt.title("Im(y)"); plt.xlabel("Numer probki"); plt.ylabel("Amplituda")
plt.subplot(3, 2, 3); plt.stem(ftt_re); plt.title("Re(fft(y))"); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Amplituda"); plt.axis((0, 31, -1, 1))
plt.subplot(3, 2, 4); plt.stem(fft_im); plt.title("Im(fft(y))"); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Amplituda")
plt.subplot(3, 2, 5); plt.stem(fft_abs); plt.title("Modul(fft(y))"); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Magnituda")
plt.subplot(3, 2, 6); plt.stem(fft_ang); plt.title("Phase(fft(y))"); plt.ylabel("Faza [pi x rad]"); plt.xlabel("Numer pasma czestotliwosciowego")
plt.tight_layout()
...
plt.figure(figsize=(12, 14))
plt.subplot(3, 2, 1); plt.stem(y); plt.title("y"); plt.xlabel("Numer probki"); plt.ylabel("Amplituda")
plt.subplot(3, 2, 2); plt.stem(ifft_moje); plt.title("y - Funkcja Wlasna IDFT"); plt.xlabel("Numer probki"); plt.ylabel("Amplituda")
plt.subplot(3, 2, 3); plt.stem(fft_abs); plt.title("Modul Widma FFT"); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Magnituda")
plt.subplot(3, 2, 4); plt.stem(fft_moje_abs); plt.title("Modul Widma - Funkcja Wlasna"); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Magnituda")
...
plt.figure(figsize=(12, 14))
plt.subplot(3, 2, 1); plt.stem(y1); plt.title("y1"); plt.xlabel("Numer probki"); plt.ylabel("Amplituda")
plt.subplot(3, 2, 2); plt.stem(y1_ifft_moje); plt.title("y1 - własna funkcja IDFT"); plt.xlabel("Numer probki"); plt.ylabel("Amplituda")
plt.subplot(3, 2, 3); plt.stem(y1_fft_abs); plt.title("Modul Widma FFT"); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Magnituda")
plt.subplot(3, 2, 4); plt.stem(y1_fft_abs_moje); plt.title("Modul Widma - Funkcja Wlasna"); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Magnituda")
...
plt.figure(figsize=(12, 14))
plt.subplot(3, 2, 1); plt.stem(y2); plt.title("y2"); plt.xlabel("Numer probki"); plt.ylabel("Amplituda")
plt.subplot(3, 2, 2); plt.stem(y2_ifft_moje); plt.title("y2 - własna funkcja IDFT"); plt.xlabel("Numer probki"); plt.ylabel("Amplituda")
plt.subplot(3, 2, 3); plt.stem(y2_fft_abs); plt.title("Modul Widma FFT"); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Magnituda")
plt.subplot(3, 2, 4); plt.stem(y2_fft_abs_moje); plt.title("Modul Widma - Funkcja Wlasna"); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Magnituda")
...
plt.figure(figsize=(12, 14))
plt.subplot(3, 2, 1); plt.stem(y3); plt.title("y3"); plt.xlabel("Numer probki"); plt.ylabel("Amplituda")
plt.subplot(3, 2, 2); plt.stem(y3_ifft_moje); plt.title("y3 - własna funkcja IDFT"); plt.xlabel("Numer probki"); plt.ylabel("Amplituda")
plt.subplot(3, 2, 3); plt.stem(y3_fft_abs); plt.title("Modul Widma FFT"); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Magnituda")
plt.subplot(3, 2, 4); plt.stem(y3_fft_abs_moje); plt.title("Modul Widma - Funkcja Wlasna"); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Magnituda")
...
plt.figure(figsize=(12, 14))
plt.subplot(3, 2, 1); plt.stem(y4); plt.title("y4"); plt.xlabel("Numer probki"); plt.ylabel("Amplituda")
plt.subplot(3, 2, 2); plt.stem(y4_ifft_moje); plt.title("y4 - własna funkcja IDFT"); plt.xlabel("Numer probki"); plt.ylabel("Amplituda")
plt.subplot(3, 2, 3); plt.stem(y4_fft_abs); plt.title("Modul Widma FFT"); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Magnituda")
plt.subplot(3, 2, 4); plt.stem(y4_fft_abs_moje); plt.title("Modul Widma - Funkcja Wlasna"); plt.xlabel("Numer Pasma Czestotliwosciowego"); plt.ylabel("Magnituda")
...
ax = axs[2,0]; ax.stem(fft_hann); ax.set_title("Modul FFT - Hann"); ax.set_xlabel("Numer Pasma Czestotliwosciowego"); ax.set_ylabel("Magnituda")
