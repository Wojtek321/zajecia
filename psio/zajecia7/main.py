...
# ax = axs[0,0]; ax.imshow(img1, cmap='grey'); ax.axis('off'); ax.set_title("cameraman.tif")
# ax = axs[0,1]; ax.hist(img1.ravel(), bins=256, range=(0,256)); ax.set_title("cameraman.tif - hisotgram"); ax.set_xlabel("Wartość piksela"); ax.set_ylabel("Ilość pikseli")
# ax = axs[1,0]; ax.imshow(img1_blurred, cmap='grey'); ax.axis('off'); ax.set_title("cameraman.tif - binaryzacja")
# ax = axs[1,1]; ax.hist(img1_blurred.ravel(), bins=256, range=(0,256)); ax.set_title("cameraman.tif - binaryzacja - hisotgram"); ax.set_xlabel("Wartość piksela"); ax.set_ylabel("Ilość pikseli")
# fig.set_tight_layout(tight=True)
...
ax = axs[0,0]; ax.imshow(img1, cmap='grey'); ax.axis('off'); ax.set_title("cameraman.tif")
ax = axs[0,1]; ax.hist(img1.ravel(), bins=256, range=(0,256)); ax.set_title("cameraman.tif - hisotgram"); ax.set_xlabel("Wartość piksela"); ax.set_ylabel("Ilość pikseli")
ax = axs[1,0]; ax.imshow(img1_sharp, cmap='grey'); ax.axis('off'); ax.set_title("cameraman.tif - binaryzacja")
ax = axs[1,1]; ax.hist(img1_sharp.ravel(), bins=256, range=(0,256)); ax.set_title("cameraman.tif - binaryzacja - hisotgram"); ax.set_xlabel("Wartość piksela"); ax.set_ylabel("Ilość pikseli")
fig.set_tight_layout(tight=True)
...
ax = axs[0,0]; ax.imshow(img2, cmap='grey'); ax.axis('off'); ax.set_title("livingroom.tif")
ax = axs[0,1]; ax.hist(img2.ravel(), bins=256, range=(0,256)); ax.set_title("livingroom.tif - hisotgram"); ax.set_xlabel("Wartość piksela"); ax.set_ylabel("Ilość pikseli")
ax = axs[1,0]; ax.imshow(img2_sharp, cmap='grey'); ax.axis('off'); ax.set_title("livingroom.tif - binaryzacja")
ax = axs[1,1]; ax.hist(img2_sharp.ravel(), bins=256, range=(0,256)); ax.set_title("livingroom.tif - binaryzacja - hisotgram"); ax.set_xlabel("Wartość piksela"); ax.set_ylabel("Ilość pikseli")
fig.set_tight_layout(tight=True)
