...
img3 = cv2.imread("fota.jpg", cv2.IMREAD_GRAYSCALE)
...
# ax = axs[0,0]; ax.imshow(img1, cmap='grey'); ax.axis('off'); ax.set_title("cameraman.tif")
# ax = axs[0,1]; ax.hist(img1.ravel(), bins=256, range=(0,256)); ax.set_title("cameraman.tif - hisotgram"); ax.set_xlabel("Wartość piksela"); ax.set_ylabel("Ilość pikseli")
# ax = axs[1,0]; ax.imshow(img1_mniejszy_kontrast, cmap='grey'); ax.axis('off'); ax.set_title("cameraman.tif - rozjasniony")
# ax = axs[1,1]; ax.hist(img1_mniejszy_kontrast.ravel(), bins=256, range=(0,256)); ax.set_title("cameraman.tif - rosjasniony - hisotgram"); ax.set_xlabel("Wartość piksela"); ax.set_ylabel("Ilość pikseli")
# fig.set_tight_layout(tight=True)
...
# ax = axs[0,0]; ax.imshow(img2, cmap='grey'); ax.axis('off'); ax.set_title("livingroom.tif")
# ax = axs[0,1]; ax.hist(img2.ravel(), bins=256, range=(0,256)); ax.set_title("livingroom.tif - hisotgram"); ax.set_xlabel("Wartość piksela"); ax.set_ylabel("Ilość pikseli")
# ax = axs[1,0]; ax.imshow(img2_wieszky_kontrast, cmap='grey'); ax.axis('off'); ax.set_title("livingroom.tif - rozjasniony")
# ax = axs[1,1]; ax.hist(img2_wieszky_kontrast.ravel(), bins=256, range=(0,256)); ax.set_title("livingroom.tif - rosjasniony - hisotgram"); ax.set_xlabel("Wartość piksela"); ax.set_ylabel("Ilość pikseli")
# fig.set_tight_layout(tight=True)
...
# ax = axs[0,0]; ax.imshow(img1, cmap='grey'); ax.axis('off'); ax.set_title("cameraman.tif")
# ax = axs[0,1]; ax.hist(img1.ravel(), bins=256, range=(0,256)); ax.set_title("cameraman.tif - hisotgram"); ax.set_xlabel("Wartość piksela"); ax.set_ylabel("Ilość pikseli")
# ax = axs[1,0]; ax.imshow(img1_zbinaryzowany, cmap='grey'); ax.axis('off'); ax.set_title("cameraman.tif - rozjasniony")
# ax = axs[1,1]; ax.hist(img1_zbinaryzowany.ravel(), bins=256, range=(0,256)); ax.set_title("cameraman.tif - rosjasniony - hisotgram"); ax.set_xlabel("Wartość piksela"); ax.set_ylabel("Ilość pikseli")
# fig.set_tight_layout(tight=True)
...
# ax = axs[0,0]; ax.imshow(img2, cmap='grey'); ax.axis('off'); ax.set_title("livingroom.tif")
# ax = axs[0,1]; ax.hist(img2.ravel(), bins=256, range=(0,256)); ax.set_title("livingroom.tif - hisotgram"); ax.set_xlabel("Wartość piksela"); ax.set_ylabel("Ilość pikseli")
# ax = axs[1,0]; ax.imshow(img2_zbinaryzowany, cmap='grey'); ax.axis('off'); ax.set_title("livingroom.tif - rozjasniony")
# ax = axs[1,1]; ax.hist(img2_zbinaryzowany.ravel(), bins=256, range=(0,256)); ax.set_title("livingroom.tif - rosjasniony - hisotgram"); ax.set_xlabel("Wartość piksela"); ax.set_ylabel("Ilość pikseli")
# fig.set_tight_layout(tight=True)
